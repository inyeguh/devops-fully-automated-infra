...
## CICD Infra setup
1) ###### GitHub setup
    Import GitHub Repository by using the existing repo "devops-fully-automated-infra" (https://github.com/inyeguh/devops-fully-automated-infra)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Import repository "devops-fully-automated-infra" (https://github.com/inyeguh/devops-fully-automated-infra.git) & name it "devops-fully-automated-infra"**
